...
import encHex from "crypto-js/enc-hex";  // ✅ convert hash to hex string
...
export default function Signin() {
  ...
  const onSubmit = async (data) => {
    ...
    const hashedPassword = sha256(data.password).toString(encHex);
    ...
    if (!res.ok) {
      return setError(res.error || "Signin failed");
    }
