...
// 1. Ensure this path matches your GIF file name in the `assets` folder
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-[#0f0f1a] via-[#1a1a2e] to-[#0f0f1a] text-white font-sans overflow-x-hidden">
      ...
      <img
        ...
        // 2. Increased opacity for better visibility (you can adjust this value)
      ...
      <div className="flex flex-col items-center justify-center 
        ...
        <div className="flex justify-center gap-6 flex-wrap z-10 mb-6">
          ...
          <AnimatedButton onClick={() => navigate("/how-it-works")}>
            Learn more
          </AnimatedButton>
        </div>
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 bg-gradient-to-r from-purple-400 to-pink-400 text-transparent bg-clip-text pb-6">
          Why Moodify?
        </h2>
